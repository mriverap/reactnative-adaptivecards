export const payload = {
  ...
  version: '1.5',
  speak:
    '<s>Weather forecast for Tuesday is high of 50 and low of 39 degrees with a 31% chance of rain</s><s>Winds will be 4 mph from the SSE</s>',
  backgroundImage: {
      ...
      columns: [
        ...
        },
        {
          ...
          items: [
            {
              type: 'TextBlock',
              text: '{{DATE(2019-11-05T15:00:51+00:00, SHORT)}}',
              weight: 'Bolder',
              size: 'Large',
              wrap: true,
            },
